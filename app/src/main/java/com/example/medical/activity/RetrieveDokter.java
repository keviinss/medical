...
import com.example.medical.adapter.UserAdapterDokter;
...
public class RetrieveDokter extends AppCompatActivity {
    private RecyclerView recyclerView;
    private UserAdapterDokter userAdapter;
    private List<User> userList;
    private ImageView btnLogout, img_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieve_dokter);
    ...
    private void search(String str)
    {
        ...
        userAdapter = new UserAdapterDokter(RetrieveDokter.this, myList);
    ...
    private void readUsers() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                userAdapter = new UserAdapterDokter(getApplicationContext(), userList);
                recyclerView.setAdapter(userAdapter);
